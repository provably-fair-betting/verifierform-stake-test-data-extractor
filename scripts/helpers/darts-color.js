...
const KNOWN_DARTS_COLORS = Object.values(DARTS_COLORS);

const DARTS_COLOR_TO_MULTI = {
  easy: {
...
export function resolveDartsColorOutcome(fill, difficulty) {
  ...
  const multi = DARTS_COLOR_TO_MULTI[difficulty][pixelColor];
...
function normalizeDartsColor(fill) {
